                ...
                <div class="col-lg-7 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Wecreate est un espace dédié pour former et accompagner les jeunes afin de les amener à saisir les opportunités qu’offrent les technologies du numérique.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Partenaire</h2>
                        <p>Ils croient en nous, accompagnent et soutiennent nos activités</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="about_text">
                        ...
                        <p>Ainsi le fablab de Wecreate travail sur 3 projets innovant qui seront finalisé en décembre 2019 et présentés en janvier 2020.
                         ...
                         <ul class="unordered-list">
                            ...
                            <li>
                            <b>H-prothèse :</b> prothèse médicale imprimée en 3D pour les entorses, fractures et amputés
                            </li>
                            <li>
...
<section id="team" class="pb-5">
    <div class="container">
        <h5 class="section-title h1">L’équipe dirigeante</h5>
        <div class="row">
            <!-- Team member -->
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="public/img/moctar.jpg" alt="card image"></p>
                                    <h4 class="card-title">Almoctar Seyni Moussa</h4>
                                    <p class="card-text">Directeur Exécutif et Fondateur</p>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Akanni Osias</h4>
                                    <p class="card-text">Responsable des programmes de formation et de l’accompagnement des projets (Fablab et CFSI)</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Yasmina Mohamed Boubacar</h4>
                                    <p class="card-text">Responsable de la communication, gestion interne et des relations externe</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Moumouni Idé Abdoul Razak</h4>
                                    <p class="card-text">Administrateur général HR et Comptabilité</p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
            <div class="col-lg-12">
            <h5 class="section-title h2">Associer et Consultants technique</h5>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Hanson Johnson</h4>
                                    <p class="card-text">CEO Start Innovation Hub </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Bachir Rabo</h4>
                                    <p class="card-text">Developper expert (Facebook co, 42 Coding school Fremont) </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_06.jpg" alt="card image"></p>
                                    <h4 class="card-title">Daouda Hamadou</h4>
                                    <p class="card-text">CEO Novatech </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_06.jpg" alt="card image"></p>
                                    <h4 class="card-title">Rabia Moussa</h4>
                                    <p class="card-text">Developper expert et spécialistes des questions du genre (dans le numérique) </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_06.jpg" alt="card image"></p>
                                    <h4 class="card-title">Boulama Kandine</h4>
                                    <p class="card-text">CEO Otimbilabs </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_06.jpg" alt="card image"></p>
                                    <h4 class="card-title">Hussein Abil</h4>
                                    <p class="card-text">Développer expert (42 Coding school Fremont) </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_06.jpg" alt="card image"></p>
                                    <h4 class="card-title">Abdoul Razak Adamou Komche</h4>
                                    <p class="card-text">Développer expert (2ISOFT) </p>
                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
